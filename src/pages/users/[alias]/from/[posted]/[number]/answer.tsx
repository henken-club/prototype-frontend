...
import {transformerPrejudiceAnswerPage} from '~/transformer/PrejudiceAnswerPage';

export type UrlQuery = {alias: string; posted: string; number: string};
export const getServerSideProps: GetServerSideProps<
  Exclude<ReturnType<typeof transformerPrejudiceAnswerPage>, null>,
  UrlQuery
> = async ({params}) => {
  if (
    !params ||
  ...
  return graphqlSdk
    ...
    .then(transformerPrejudiceAnswerPage)
